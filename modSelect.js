...
function allQOLMods1202() {
    ...
    modCheckbox[7] = document.querySelector('input[data-mod="mods/1.20.2/simple-armor-hud-1.20.2-1.4.0.jar"]');
    modCheckbox[8] = document.querySelector('input[data-mod="mods/1.20.2/slyde-1.7.2.jar"]');
    modCheckbox[9] = document.querySelector('input[data-mod="mods/1.20.2/yosbr-0.1.2.jar"]');
    for (let i = 0; i < 10; i++) {
        if (modCheckbox[i]) modCheckbox[i].checked = true;
    }
}
